...
open class Reporte (lexema:String, linea:Int, columna:Int, descripcion:String): Serializable{//en el caso de las operaciones, el lexema estará conformado tb por los valores de los símbolos a su izq y der!
